...
public class ProductServiceImpl implements ProductService{
    ...
    public Product createProduct(CreateProductRequest req) {
        ...
        Category secondLevel = categoryrepository.findByNameAndParentCategory(req.getSecondLevelCategory(),
                topLevel.getName());
        if(secondLevel==null){
        ...
        Category thirdLevel = categoryrepository.findByNameAndParentCategory(req.getThirdLevelCategory(),
                secondLevel.getName());
        if(thirdLevel==null) {
