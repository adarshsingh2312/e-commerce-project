...
public class ProductServiceImpl implements ProductService{
    ...
    public Product createProduct(CreateProductRequest req) {
        ...
        Category secondLevel = categoryrepository.findByNameAndParentCatr(req.getSecondLevelCategory(),
                topLevel.getName());
        if(secondLevel==null){
        ...
        Category thirdLevel = categoryrepository.findByNameAndParentCatr(req.getThirdLevelCategory(),
                secondLevel.getName());
        if(thirdLevel==null) {
