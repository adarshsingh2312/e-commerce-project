...
public class ProductServiceImpl implements ProductService{
    ...
    private static @NonNull Product getProduct(CreateProductRequest req, Category thirdLevel) {
        ...
        product.setGender(ProductCategoryMapper.normalizeGender(req.getGender()));
        product.setProductCategory(ProductCategoryMapper.normalizeProductCategory(req.getCategory()));
        product.setSubCategory(ProductCategoryMapper.normalizeSubCategory(req.getSubCategory()));
        ProductCategoryMapper.applyNormalizedFields(product);
        return product;
    }
    ...
    public Page<Product> getAllProducts(String gender, String category, List<String> colors, List<String> sizes,
        ...
        String normalizedGender = ProductCategoryMapper.normalizeGender(gender);
        String normalizedCategory = ProductCategoryMapper.normalizeProductCategory(category);
        List<Product> products = productrepository.filterProducts(normalizedGender, normalizedCategory,minPrice,maxPrice,minDiscount,sort);
