...
* **Order Creation & Stage Tracking**: Address-based checkout, producing order summaries tracked by a visual status timeline (Pending -> Placed -> Confirmed -> Shipped -> Delivered).
